    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarritosProductos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarritosProductos_Carritos_IdCarrito",
                        column: x => x.IdCarrito,
                        principalTable: "Carritos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarritosProductos_Productos_IdProducto",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PedidosProductos_Productos_IdProducto",
                        column: x => x.IdProducto,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carritos_IdSesion",
                table: "Carritos",
                column: "IdSesion",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CarritosProductos_IdCarrito",
                table: "CarritosProductos",
                column: "IdCarrito");

            migrationBuilder.CreateIndex(
                name: "IX_CarritosProductos_IdProducto",
                table: "CarritosProductos",
                column: "IdProducto");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidosProductos_IdProducto",
                table: "PedidosProductos",
                column: "IdProducto");
